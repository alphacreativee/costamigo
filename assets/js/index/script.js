...
function swiperBanner() {
  ...
  sliders.forEach((container) => {
    ...
    const swiperButton = container.querySelector(".swiper-btn-custom");
    if (!swiperButton) return;
    ...
    container.addEventListener("mousemove", (e) => {
      ...
      swiperButton.style.left = mouseX - swiperButton.offsetWidth / 2 + "px";
      swiperButton.style.top = mouseY - swiperButton.offsetHeight / 2 + "px";

      const halfWidth = rect.width / 2;

      if (mouseX <= halfWidth) {
        swiperButton.style.transform =
          "translate3d(0,0,0) rotate(180deg) scale(1)";
      } else {
        swiperButton.style.transform =
    ...
    // CLICK TO SLIDE (bind container — not button)
